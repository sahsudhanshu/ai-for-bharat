...
function assessConnectionQuality(state: NetInfoState): 'excellent' | 'good' | 'poor' | 'offline' {
...
export function NetworkProvider({ children }: { children: ReactNode }) {
    ...
    const [effectiveMode, setEffectiveMode] = useState<'online' | 'offline'>('online');
    ...
    return (
        <NetworkContext.Provider value={{ isOnline, isChecking, connectionQuality, effectiveMode }}>
            {children}
...
export async function testConnectionSpeed(apiUrl: string): Promise<boolean> {
    ...
    try {
        ...
        const timeoutId = setTimeout(() => controller.abort(), SLOW_CONNECTION_TIMEOUT);
