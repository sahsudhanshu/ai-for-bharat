...
export default function HomeScreen() {
    ...
    const FEATURES = [
        { emoji: '📷', title: t('nav.upload'), desc: t('home.toolUploadDesc'), route: '/upload', color: COLORS.primary },
        { emoji: '🗺️', title: t('nav.oceanMap'), desc: t('home.toolMapDesc'), route: '/map', color: COLORS.secondary },
        { emoji: '💬', title: t('nav.assistant'), desc: t('home.toolChatDesc'), route: '/chat', color: COLORS.accent },
        { emoji: '📊', title: t('nav.analytics'), desc: t('home.toolAnalyticsDesc'), route: '/analytics', color: '#7c3aed' },
    ];
        ...
        <SafeAreaView style={styles.safe}>
            ...
            >
                ...
                <Card style={styles.insightCard} padding={SPACING.lg}>
                    {[
                        { label: t('home.insightTime'), value: '5:00–8:00 AM', emoji: '⏰' },
                        { label: t('home.insightSpecies'), value: analytics?.topSpecies ?? 'Indian Pomfret', emoji: '🐠' },
                        { label: t('home.insightSustainability'), value: '88/100', emoji: '♻️' },
                        { label: t('home.insightMarket'), value: 'Pomfret ↑12%', emoji: '📈' },
                    ].map((item, i) => (
