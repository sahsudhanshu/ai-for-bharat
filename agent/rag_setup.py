...
# ── Config ----------------------------------------------------------------
AOSS_ENDPOINT  = os.getenv("AOSS_ENDPOINT",  "https://drs6m0eqllzngd1mwed2.us-east-1.aoss.amazonaws.com")
AOSS_REGION    = os.getenv("BEDROCK_REGION",  "us-east-1")
AOSS_INDEX     = os.getenv("AOSS_INDEX_NAME", "fish-gemini-index")
S3_BUCKET      = os.getenv("BEDROCK_S3_BUCKET", "fish-detection-project-2026")
